                            ...
                            <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.15s ease;">
                                <td style="padding: 16px 20px;">
                                    <div style="display: flex; align-items: center; gap: 12px;">
                                        <img src="{{ $u->avatar ?? 'https://api.dicebear.com/7.x/bottts/svg?seed=' . $u->id }}" style="width: 40px; height: 40px; border-radius: 50%; background: #f1f5f9; border: 1.5px solid #e2e8f0;" alt="">
                                        <div>
                                ...
                                <td style="padding: 16px 20px;">
                                    <div style="display: flex; gap: 12px; font-size: 12px; font-weight: 700;">
                                        <span style="color: var(--primary-blue);">{{ number_format($u->xp) }} XP</span>
                                        <span style="color: var(--accent-orange);">🔥 {{ $u->streak_count }}d</span>
                                        <span style="color: var(--accent-red);">❤️ {{ $u->hearts }}/5</span>
                                        <span style="color: #0284c7;">💎 {{ $u->gems }}</span>
                                    </div>
                                </td>
