@php
    $title = 'Edit Kursus: ' . $course->title . ' - Mentor EduSkill';
@endphp
...
<x-app-layout :title="$title">
    <div style="max-width: 680px; margin: 0 auto; width: 100%;">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <h1 style="font-size: 24px; font-weight: 900; color: #0f172a;">Edit Info Kursus</h1>
            <p style="color: #64748b; font-size: 14px;">Perbarui judul, tingkat kesulitan, atau status kursus.</p>
        </div>
        ...
        <div class="card-3d" style="padding: 28px;">
            <form action="{{ route('mentor.courses.update', $course->id) }}" method="POST" style="display: flex; flex-direction: column; gap: 18px;">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="target_audience" value="{{ old('target_audience', $course->target_audience) }}" style="width: 100%; padding: 12px 16px; border: 2px solid #cbd5e1; border-radius: 14px; font-size: 14px; font-weight: 600; outline: none;">
                </div>
