        ...
        <div style="display: flex; flex-direction: column; gap: 20px; width: 100%;">
            ...
            <div class="card-3d" style="padding: 20px;">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                    ...
                    <span style="font-size: 11px; font-weight: 800; color: var(--primary-blue);">RESET 24 JAM</span>
                </div>
            ...
            <div class="card-3d" style="padding: 20px;">
                ...
                @foreach ($topStudents as $rank => $student)
                    <div style="display: flex; align-items: center; gap: 12px; padding: 8px 0; border-bottom: 1px solid #f1f5f9;">
                        <div style="font-size: 14px; font-weight: 900; width: 20px; color: {{ $rank == 0 ? 'var(--primary-blue)' : '#64748b' }};">
                            #{{ $rank + 1 }}
                        </div>
                        <img src="{{ $student->avatar ?? 'https://api.dicebear.com/7.x/bottts/svg?seed=' . $student->id }}" style="width: 32px; height: 32px; border-radius: 50%; background: #f1f5f9;" alt="">
